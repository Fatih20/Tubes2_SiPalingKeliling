...
class DFS {
    ...
    static void tspDFS(char[,] map, int x, int y, int xBefore, int yBefore, bool[,] isVisited, List<Tuple<int,int>> path, List<Tuple<int,int>> track, ref bool finish){
        /*
    ...
    static void setSolutionTSP(char[,] buffer, List<Tuple<int,int>> path, Tuple<int,int> start, Tuple<int,int> end){
